...
import { getLocationsForTrainQuery } from "../services/queries/getLocationsForTrainQuery.js";
...
import { convertWgs84, getBearing, getDateFormat, getDistance, getMiddlePoint } from "../utils/common.mjs";
